...
async function main(): Promise<void> {
  ...
  try {
    ...
    // Parse transport configuration from runtime arguments
    ...
    logger.info(`Configuring transport: ${transportArg}`);
    ...
    const transportManager = new TransportManager(
      ...
      logger,
      {
        supportStdio: transportArg === "stdio",
        supportSse: transportArg === "sse",
        supportHttp: transportArg === "sse", // SSE requires HTTP
      },
    );
